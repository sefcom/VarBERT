...
#             return pad_sequence(examples[0], batch_first=True),pad_sequence(examples[1], batch_first=True)
#         return pad_sequence(examples[0], batch_first=True, padding_value=tokenizer.pad_token_id),pad_sequence(examples[1], batch_first=True, padding_value=tokenizer.pad_token_id)
